...
. Then, I have unzip the content of this archive (which contains the folder `\go`) to my `C:\Users\720330787\AppData\Local\Programs`, you just need to find a place on your `C:\` drive on which you can write, and that is not cleanup periodically by your administrator!