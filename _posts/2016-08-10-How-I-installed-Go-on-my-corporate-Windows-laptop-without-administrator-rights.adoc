...
. Download the latest *archive* file for Windows; I have used link:https://storage.googleapis.com/golang/go1.6.3.windows-amd64.zip[go1.6.3.windows-amd64.zip^] one;
